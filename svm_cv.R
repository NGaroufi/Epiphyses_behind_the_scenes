...
write.csv(mae_vars, paste0("./Tibia/CV_SVM_80/Fold_", f, "_MAE.csv"))
...
write.csv(five_pr, paste0("./Tibia/CV_SVM_80/Fold_", f, "_combo_pred_", meth[m], ".csv"))
write.csv(five_pr_20, paste0("./Tibia/CV_SVM_80/Fold_", f, "_20_pred_", meth[m], ".csv"))
write.csv(five_pr_80, paste0("./Tibia/CV_SVM_80/Fold_", f, "_80_pred_", meth[m], ".csv"))
...
write.csv(stats, paste0("./Tibia/CV_SVM_80/Fold_", f, "_stats_", meth[m], ".csv"))
write.csv(sorted, paste0("./Tibia/CV_SVM_80/Fold_", f, "_sorted_", meth[m], ".csv"))
...
write.csv(md_true, paste0("./Tibia/CV_SVM_80/Fold_", f, "_MD_true_", meth[m], ".csv"))
write.csv(results, paste0("./Tibia/CV_SVM_80/Fold_", f, "_Accuracy_", meth[m], ".csv"))

write.csv(five_pr_dis,
          paste0("./Tibia/CV_SVM_80/Fold_", f, "_combo_pred_dis_", meth[m], ".csv"))
write.csv(five_pr_dis_20,
          paste0("./Tibia/CV_SVM_80/Fold_", f, "_20_pred_dis_", meth[m], ".csv"))
write.csv(five_pr_dis_80,
          paste0("./Tibia/CV_SVM_80/Fold_", f, "_80_pred_dis_", meth[m], ".csv"))
